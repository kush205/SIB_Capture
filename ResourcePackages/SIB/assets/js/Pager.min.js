function ASPSnippetsPager(a, b) {
    ...
    var left = culture == "en" ? "left" : "right";
    var right = culture == "en" ? "right" : "left";
    ...
    var d = "<li class='page-item active'><a style='cursor:pointer' class='page-link active' href='javascript:'>{0}</a></li>";
    var e, f, g;
    var g = 5;
    ...
    if (h > 1) {
        ...
        if (b.PageIndex > 1) {
            i += c.replace("{0}", "<span aria-hidden='true'><i class='icon-" + left + "-arrow'></i></span>").replace("{1}", "1");
        ...
        if (b.PageIndex < h) {
            //i += c.replace("{0}", ">").replace("{1}", b.PageIndex + 1);
            i += c.replace("{0}", "<span aria-hidden='true'><i class='icon-" + right + "-arrow'></i></span>").replace("{1}", h);
